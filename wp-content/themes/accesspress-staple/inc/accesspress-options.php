...
function optionsframework_options() {
   ...
   $theme = wp_get_theme();
	...
	$about_content = '<div class="about-accesspress">
          ...
          '<br/><br/>
          <a class="button" target="_blank" href="'.esc_url('https://accesspressthemes.com/documentation/theme-instruction-accesspress-staple/').'">'. __('View Documentaion','accesspress-staple').'</a>
          <a class="button" target="_blank" href="'.esc_url('http://accesspressthemes.com/theme-demos/?theme=accesspress-staple').'">'.__('View Demo','accesspress-staple').'</a>
        </div>';
